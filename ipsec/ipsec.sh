...
# ==================================================
# Link Hosting Kalian
fromhell26="raw.githubusercontent.com/donaya365/valdemort/main/ipsec"
...
wget -O /usr/bin/addl2tp http://${fromhell26}/addl2tp.sh && chmod +x /usr/bin/addl2tp
wget -O /usr/bin/dell2tp http://${fromhell26}/dell2tp.sh && chmod +x /usr/bin/dell2tp
wget -O /usr/bin/addpptp http://${fromhell26}/addpptp.sh && chmod +x /usr/bin/addpptp
wget -O /usr/bin/delpptp http://${fromhell26}/delpptp.sh && chmod +x /usr/bin/delpptp
wget -O /usr/bin/renewpptp http://${fromhell26}/renewpptp.sh && chmod +x /usr/bin/renewpptp
wget -O /usr/bin/renewl2tp http://${fromhell26}/renewl2tp.sh && chmod +x /usr/bin/renewl2tp
