...
clear #==================================================
# Link Hosting Kalian
fromhell26="raw.githubusercontent.com/fromhell26/scriptvps/main/"
...
echo -e "${Info} Wireguard Script Mod JoySmark"
...
# Tambahan
cd /usr/bin
wget -O addwg "https://raw.githubusercontent.com/fromhell26/scriptvps/main/wireguard/addwg.sh"
wget -O delwg "https://raw.githubusercontent.com/fromhell26/scriptvps/main/wireguard/delwg.sh"
wget -O renewwg "https://raw.githubusercontent.com/fromhell26/scriptvps/main/wireguard/renewwg.sh"
chmod +x addwg
chmod +x delwg
chmod +x renewwg
cd
