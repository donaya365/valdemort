...
# ==================================================
# Link Hosting Kalian
fromhell26="raw.githubusercontent.com/donaya365/valdemort/main/ssh"
#
# initializing var
...
wget -qO- -O /etc/ssh/sshd_config https://raw.githubusercontent.com/donaya365/valdemort/main/sshd_config
systemctl restart sshd

#Dropbear
apt -y install dropbear
wget -O /etc/default/dropbear "https://${Mjoyvpn}/dropbear"
...
# Ganti Banner
wget -O /etc/issue.net "https://raw.githubusercontent.com/donaya365/valdemort/main/ssh/issue.net"
/etc/init.d/ssh restart
/etc/init.d/dropbear restart
