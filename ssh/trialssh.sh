...
echo -e "=============================="
echo -e "Payload Websocket MAXIS & DIGI TLS"
echo -e "=============================="
echo -e "GET wss://who.int/ HTTP/1.1[crlf]Host:${domain}[crlf]Upgrade: websocket[crlf][crlf]"
echo -e "=============================="
echo -e "Payload Websocket indonesia No TLS"
echo -e "=============================="
