...
clear
# Link Hosting Kalian
fromhell26="raw.githubusercontent.com/donaya365/valdemort/main//sstp"
...
commonname=kibocelcom@gmail.com
...
#input perintah sstp
wget -O /usr/bin/addsstp http://${fromhell26}/addsstp.sh && chmod +x /usr/bin/addsstp
wget -O /usr/bin/delsstp http://${Koyvpn}/delsstp.sh && chmod +x /usr/bin/delsstp
wget -O /usr/bin/ceksstp http://${fromhell26}/ceksstp.sh && chmod +x /usr/bin/ceksstp
wget -O /usr/bin/renewsstp http://${fromhell26}/renewsstp.sh && chmod +x /usr/bin/renewsstp
rm -f /root/sstp.sh
