...
# DNS PATCH
#tipeos2=$(uname -m)
Name=$(curl -sS https://raw.githubusercontent.com/donaya365/valdemort/main/running.sh | grep $MYIP | awk '{print $2}')
Exp=$(curl -sS https://raw.githubusercontent.com/donaya365/valdemort/main/running.sh | grep $MYIP | awk '{print $3}')
# GETTING DOMAIN NAME
